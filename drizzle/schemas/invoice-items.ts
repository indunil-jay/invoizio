...
export const invoiceItemsSchema = createInsertSchema(invoiceItems, {
    ...
    taxRate: (schema) =>
        schema.min(0, "Tax rate must be a non-negative number."),
    discountRate: (schema) =>
...
export type CreateInvoiceItem = z.infer<typeof invoiceItemsSchema>;
export type InvoiceItemEntity = InferSelectModel<typeof invoiceItems>;
