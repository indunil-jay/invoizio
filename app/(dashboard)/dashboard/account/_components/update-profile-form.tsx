                            ...
                            <FormItem>
                                ...
                                <div>
                                    <ul className="list-disc text-xs text-muted-foreground space-y-2">
                                        <li>
                                            Updating your email address will
                                            automatically log you out. You will
                                            need to verify your new email and
                                            log in again to continue.
                                        </li>
                                        <li>
                                            If you originally logged in using a
                                            provider account (e.g., Google), you
                                            cannot directly switch to a
                                            different email for the same
                                            provider account.
                                        </li>
                                        <li>
                                            To use a different email, you must
                                            first update your account email.
                                            After the update, you will need to
                                            log in using your new email address
                                            and password instead of the provider
                                            account.
                                        </li>
                                        <li>
                                            If you do not have a password set
                                            yet (because you were using a
                                            provider account), you must use the{" "}
                                            <strong>Forgot Password</strong>{" "}
                                            option after logging out to create
                                            one.
                                        </li>
                                        <li>
                                            Once you set a password and verify
                                            your new email, you can log in using
                                            your updated email and password
                                            combination.
                                        </li>
                                    </ul>
                                </div>
